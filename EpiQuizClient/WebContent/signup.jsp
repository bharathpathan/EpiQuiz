...
<body class="rounded" style="background-color:#FCF3CF ">
    ...
    <main role="main" class="container">
        ...
        <div class="starter-template">
            ...
            <p class="lead">this is a online quiz program where admin can create the quiz and users can participate in a quiz.</p>
        		<p class="lead">Signup Page.</p>
        </div></div>
      
    <form name= "Signupservlet" action="Signupservlet" method="post">
 ...
 <div class="checkbox" style="padding-left: 50px"><label class="checkbox-inline" style="padding-left: 300px">create admin account<input type="checkbox" value="admin" class="form-control" name ="admin"></label>
  </div>
