...
<body class="rounded" style="background-color:#FCF3CF ">
    ...
    <thead>
      <tr>
          <th><a href="login.jsp"><button type="button" class="btn btn-success" >Admin Login</button></a>
            <h5 class="text-danger">Login as an admin to<mark>create a quiz</mark>. </h5></th>
        <th></th>
      
      </tr>
           <tr>
        <th></th>
               <th><a href="login.jsp"><button type="button" class="btn btn-success" >Student Login</button></a>
